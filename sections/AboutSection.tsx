...
I have skilled cybersecurity professional with hands-on experience in areas like Ethical Hacking, Red Teaming, and Web Penetration Testing. My passionate about securing digital infrastructures, and I have gained practical expertise in Threat Hunting, Malware Analysis, and SOC Engineering. I also involvement in Capture The Flag (CTF) challenges shows me enjoy practical problem-solving and constantly sharpening your skills.            </p>

            <div
              className="col-start-3 col-end-6 row-start-1 row-end-6 lg:row-start-2 lg:row-end-7 md:ml-8 place-content-end"
              ref={eduRef}
            >
              <p className="edu-bg my-4"></p>
...
const educationInfo = [
  {
    ...
    subTitle: "Meghna Cloud - A JV of BDCCL & GenNext Technologies Limited  | 10 FEBRUARY 2025 - Continue",
    list: [
      "Monitored security events and alerts, ensuring quick identification and response to potential threats.",
      "Investigated and analyzed security incidents, identifying root causes and implementing corrective actions..",
      "Responded to incidents, implementing containment measures to prevent further damage and ensure system integrity.",
      "Collaborated with cross-functional IT teams to enhance overall security posture and resolve technical issues.",
    ],
  },
  {
    id: 2,
    title: "ENGINEER",
    subTitle: "AVIATION DHAKA CONSORTIUM TERMINAL 3 (SAMSUNG CORPORATE) | 1 FEBRUARY 2024 – 31 OCTOBER 2024",
    list: [
      " Assist in monitoring network traffic for security threats and anomalies.",
      " Support the configuration and management of firewalls, routers, and other network devices.",
      " Assist in responding to security incidents and maintaining incident network vulnerabilities.",
      " Providing network security such as security firewalls, IDS/IPS, encryption.",
      ],
  },
  {
    id: 3,
    ...
    list: [
      " troubleshooting tasks such as checking device connectivity,reviewing logs, and identifying potential bottlenecks or failures.",
      " checking for alarms or warnings related to performance metrics (CPU usage, memory, disk space, bandwidth utilization)",
      " IP addressing, subnetting, routing, and VLANs is important for basic diagnostics.",
      " execute network switch configuration at OSI layer2 (the data link layer)or layer 3 (the network layer).",
    ],
  }
];
