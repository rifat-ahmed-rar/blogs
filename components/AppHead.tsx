...
const AppHead: React.FC<Props> = ({
  ...
  let author = "RAR";
  let description =
    "Articles about network, analysis, coding, technologies, reverse engineering, my personal projects and my experiences.";
  let siteName = "RAR's Blog";
  let type = "article";
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/`;
  let appOgImageAlt = "RAR's Blog";
